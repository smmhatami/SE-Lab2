...
<tbody>
    ...
    <td>
    <p>در واسط OrderService بسیار بیشتر از یک کار پیاده سازی شده که نقض آشکار این اصل به شمار می رود. 
</p>
    </td>
    </tr>
    <tr>
...
<tbody>
    ...
    <td width="246">
    <p>واسط سرویس چندین کار را انجام میدهد و تمامی کلاس هایی که آن را پیاده سازی نموده اند این اصل را نقض کرده اند </p>
    </td>
    <td width="284">
    <p>واسط سرویس را به صورت کلی تر تعریف کرده و در کلاس های مختلف پیاده سازی گوناگونی از آن را انجام دهیم تا تنها کار های مشخص و مربوط به هم در یک کلاس صورت پذیرد</p>
    </td>
    </tr>
    <tr>
    <td width="168">
    ...
    <td width="246">
    <p>واسط مورد نظر به درستی طراحی نشده است. برای افزودن سرویس پرداختی جدید لازم است واسط و تمامی کلاس های از قبل پیاده سازی شده دچار تغییر شوند</p>
    </td>
    <td width="284">
    <p>واسط را به گونه ای بازطراحی کنیم که فقط توابع اصلی را مشخص کرده باشد و تعریف جزئی آن به عهده کلاس گذاشته شود </p>
    </td>
    </tr>
    <tr>
    <td width="168">
